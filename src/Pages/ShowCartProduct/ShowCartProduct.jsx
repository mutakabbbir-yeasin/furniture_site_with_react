        ...
        <div className="grid grid-cols-3 gap-4 p-10">
          ...
          <div className="col-span-2">
            {carts?.map((cart) => (
              <div
                key={cart._id}
                className="card card-side bg-base-100 border border-[#cd8f5c] border-spacing-2 my-3 p-3"
              >
                {/* product select */}
                ...
                {/* product image */}
                <img
                  className="w-52 h-40 object-fill"
          ...
          {/* right order details */}
          <div className="bg-gray-100 card border border-[#cd8f5c] mt-3 h-auto overflow-hidden">
